...
type Free<'f, 'r, 'a when 'f :> HKT> = 
  ...
  static member Pure (
    x: 'a,
    [<OptionalArgument>] _output: Free<'f, 'r, 'a>,
  ...
  static member Bind (value: Free<'f, 'r, 'a>, fn: 'a -> Free<'f, 'r, 'b>, [<OptionalArgument>] _mthd: Binder): Free<'f, 'r, 'b> = 
...
module Free = 
  let liftF(value: App<'f, 'r>): Free<'f, 'r, 'r > = 
    Free(value, PureValue)
