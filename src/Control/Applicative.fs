...
type Appliable =
  ...
  static member inline Apply
    (fnOpt: Option<'a -> 'b>, valueOpt: Option<'a>, [<OptionalArgument>] _mthd: Appliable) : Option<
                                                                                               'b
                                                                                              >
    =
  ...
  static member inline Apply
    (fnOpt: Result<'a -> 'b, 'e>, valueOpt: Result<'a, 'e>, [<OptionalArgument>] _mthd: Appliable) : Result<
                                                                                                       'b,
                                                                                                       'e
                                                                                                      >
    =
...
type Purifiable =
  static member inline Pure
    (value: 'a, [<OptionalArgument>] _output: List<'a>, [<OptionalArgument>] _mthd: Purifiable) : List<
                                                                                                    'a
                                                                                                   >
    =
    [ value ]
  ...
  static member inline Pure
    (value: 'a, [<OptionalArgument>] _output: Option<'a>, [<OptionalArgument>] _mthd: Purifiable) : Option<
                                                                                                      'a
                                                                                                     >
    =
    Some value
  ...
  static member inline Pure
    (value: 'a, [<OptionalArgument>] _output: Result<'a, _>, [<OptionalArgument>] _mthd: Purifiable) : Result<
                                                                                                         'a,
                                                                                                         _
                                                                                                        >
    =
